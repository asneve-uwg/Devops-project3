...
// route to index page in the page folder; .ejs
...
app.post('/api/check_phone_number', (req, res) => {
	...
	else if (!isNaN(number) && number > 999999999 && number < 100000000000) {
		res.render('page/success'); //render the success page
	}
	else { 
...
//start the web app;message on the terminal; use to debug
